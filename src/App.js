        ...
        return (
            <div style={{width: "80%", margin: "auto"}}>
                ...
                <Router>
                    ...
                    {this.state.isAdmin ? 
                        <div style={{textAlign: "center"}}>
                            Admin Console: <Link to={`${process.env.PUBLIC_URL}/items`}>Items</Link> | <Link to={`${process.env.PUBLIC_URL}/abilities`}>Abilities</Link> | <Link to={`${process.env.PUBLIC_URL}/monsters`}>Monsters</Link>
                        </div>
                    : null}
                    <Switch>
