    ...
    render() {
        return (
            <div>
                ...
                <div>
                    <span><strong>Encounters Panel:</strong>&nbsp;&nbsp;&nbsp;<input type="text" value="https://deusprogrammer.com/util/battle-panel/encounters?channelId={this.state.channelId}" /></span>
                </div>
                <div>
                    <span><strong>Notification Panel:</strong>&nbsp;<input type="text" value="https://deusprogrammer.com/util/battle-panel/notifications?channelId={this.state.channelId}" /></span>
                </div>
                <h3>Actions</h3>
